...
a
vec1 <- 1:10   #sequence
vec2 <- rnorm  #rnorm (normal distribution)
vec2

rep(c(1, 2, 3), 2)  #replicate element ทำซ้ำ
?rep
help(rep)
help(rnorm)
?seq
...
matrix(1:4, nrow=2, byrow=TRUE)   #2*2 dim
...
emp.data <- data.frame(
  ...
  start_date = as.Date(c("2012-02-15","2014-04-13","2015-10-03","2017-05-15",
                       "2021-07-05")))
print(emp.data)
